...
(function() {
	...
	jQuery.validator.addMethod("nombres", function(value, element) {
		return this.optional(element) || /^[ñÑA-ZÁÉÍÓÚa-záéíóú _]*[ñÑA-ZÁÉÍÓÚa-záéíóú][ñÑA-ZÁÉÍÓÚa-záéíóú _]*$/.test(value);
    ...
    }, "Debe mantener este formato DD/MM/YYYY");

})();

jQuery.validator.addMethod("letterswithbasicpunc", function(value, element) {
	return this.optional(element) || /^[a-z\-.,()'\"\s]+$/i.test(value);
}, "Solo letras y puntuación");

jQuery.validator.addMethod("alphanumeric", function(value, element) {
	return this.optional(element) || /^\w+$/i.test(value);
}, "Solo letras, números y subguiones");
...
jQuery.validator.addMethod("integer", function(value, element) {
	return this.optional(element) || /^-?\d+$/.test(value);
}, "Escriba un número entero positivo o negativo");
...
jQuery.validator.addMethod("password", function(value, element) {
    return this.optional(element) || /^.*(?=.{6,})(?=.*[A-Z])(?=.*[a-z])(?=.*[\d])(?=.*[\W_]).*$/.test(value);
  }, "La contraseña debe contener mínimos 6 caracteres e incluir  mayúsculas, minúsculas, dígitos y carácteres especiales.");
