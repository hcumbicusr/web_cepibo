<?php $view = 'cuadrillas'; include_once 'header.inc.php'; ?>
<?php
//valida permisos
  $permitidos = ['Cuadrillas']; // array de permisos para estar en esta página
  $val = false;
                    ...
                    <form id="form-guardar" action="asociacion" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="text" readonly id="nombre" name="nombre" required class="form-control">
                        </div>
                      </div>
