<?php $view = 'productor'; include_once 'header.inc.php'; ?>
<?php
//valida permisos
  $permitidos = ['Productor']; // array de permisos para estar en esta página
  $val = false;
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable-productor" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th>#</th>
                          <th>Código</th>
